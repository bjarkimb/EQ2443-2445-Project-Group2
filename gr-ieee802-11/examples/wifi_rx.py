...
# Title: Wifi Rx
# Generated: Wed Dec 12 12:05:41 2018
##################################################
...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_meta_sink_0 = blocks.file_meta_sink(gr.sizeof_gr_complex*1, "/home/project/prefix/gr-ieee802-11/build/metadata", samp_rate, 1, blocks.GR_FILE_FLOAT, True, 1000000, "", False)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.ieee802_11_decode_mac_0, 'out'), (self.blocks_pdu_to_tagged_stream_0, 'pdus'))    
        ...
        self.connect((self.blocks_pdu_to_tagged_stream_0, 0), (self.blocks_file_meta_sink_0, 0))    
